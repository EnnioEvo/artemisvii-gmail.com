...
train_features_diff.to_csv('../data/train_features_clean_wmean_diff.csv', header=True, index=False)
test_features_diff.to_csv('../data/test_features_clean_wmean_diff.csv', header=True, index=False)
