...
X_old_t3 = np.array(train_features.loc[0:train_size * 12 - 1, select_features])
X_val_t3 = np.array(train_features.loc[train_size * 12:, select_features])
...
model_t1 = Sequential()
model_t1.add(Conv1D(30, kernel_size=5,
                    activation='relu',
                    input_shape=input_shape))
model_t1.add(Conv1D(30, 3, activation='relu'))
model_t1.add(MaxPooling1D(pool_size=2))
model_t1.add(Dropout(0.25))
model_t1.add(Flatten())
model_t1.add(Dense(30, activation='relu'))
...
model_t3 = Sequential()
model_t3.add(Conv1D(15, kernel_size=5,
                    activation='relu',
                    input_shape=input_shape))
