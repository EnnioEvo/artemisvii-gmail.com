...
usefulness_matrix_t3.to_csv('../data/usefulness_matrix_t3_dummy.csv', header=True, index=True, float_format='%.7f')
...
usefulness_matrix_t1.to_csv('../data/usefulness_matrix_t1_dummy.csv', header=True, index=True, float_format='%.7f')
