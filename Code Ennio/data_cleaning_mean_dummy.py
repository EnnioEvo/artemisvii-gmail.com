...
train_features_clean.to_csv('../data/train_features_clean_wmean.csv', header=True, index=False)
test_features_clean.to_csv('../data/test_features_clean_wmean.csv', header=True, index=False)
