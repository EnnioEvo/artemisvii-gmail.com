...
print(VS_data)
print(VS_data.shape)
tests_data, test_min, test_max = tests_cleaning(data_set=train_features, tests=head_tests, h_obs=12, test_min_in=None, test_max_in=None)
print(tests_data)
...
data_new.to_csv('data/train_features_clean_all_NEW_2.csv', header=True, index=False)
