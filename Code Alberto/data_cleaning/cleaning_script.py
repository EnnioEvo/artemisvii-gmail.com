...
dir_train_features = 'data/train_features_clean.csv'
tests_Set.to_csv(dir_train_features, header=True, index=False)
print("Test features -- saved under: ", dir_train_features)
print()
print()
...
dir_test_features = 'data/test_features_clean.csv'
submSet.to_csv(dir_test_features, header=col, index=False)
print("Test features -- saved under: ", dir_test_features)
